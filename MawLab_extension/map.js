...
AmCharts.ready(function() {
	...
	//map.addTitle("MawLab | Malware Laboratory", 14);
	//map.addTitle("Developer : @Bym24v", 11);
	map.areasSettings = {
	...
	map.imagesSettings.balloonText = "<span id='tool' style='font-size:14px;'><b>[[title]]</b>: [[value]]</span>";

    var dataProvider = {
        mapVar: AmCharts.maps.worldLow,
        "lines": [
            {// arriba y abajo 1 y arriba y abajo 2
                "latitudes": [38.538650, 38],
                "longitudes": [-0.123215, -97],
                "arc": -0.8,
                "color": "#a7a737"

            },
            {
                "latitudes": [38.538650, 23],
                "longitudes": [-0.123215, -102],
                "arc": -0.8,
                "color": "#a7a737"
            },
            {
                "latitudes": [38.538650, -10],
                "longitudes": [-0.123215, -55],
                "arc": -0.8,
                "color": "#86a965"
            },
            {
                "latitudes": [38.538650, 27],
                "longitudes": [-0.123215, 30],
                "arc": -0.8,
                "color": "#de4c4f"
            },
            {
                "latitudes": [38.538650, 10],
                "longitudes": [-0.123215, 8],
                "arc": -0.8,
                "color": "#de4c4f"
            }
        ],
    ...
    for (var i = 0; i < mapData.length; i++) {
        ...
        dataProvider.images.push({
            ...
            //scale: 0.7,
            zoomLevel: 2.74,
            zoomLongitude: latlong[id].longitude,
            zoomLatitude: latlong[id].latitude
        });
    }
